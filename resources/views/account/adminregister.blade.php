...
{{-- register --}}
<div class="bg-gradient-to-r from-red-600 via-red-500 to-red-800 min-h-screen items-center justify-center py-5">
    <div class="max-w-2xl mx-auto bg-white shadow-md px-6 py-7 rounded-md overflow-hidden">
        <h2 class="text-2xl uppercase font-medium mb-1">Admin Signup</h2>
        <p class="text-gray-600 mb-6 text-sm">
            ...
            <span class="font-semibold text-lg text-center text-red-500 mb-2">FindFlat</span>
                ...
                <div class="mt-4">
                    <button type="submit"
                    class="block w-full py-2 text-center text-white bg-red-600 border border-red-500 rounded-2xl hover:scale-105  hover:font-bold transition uppercase font-roboto font-medium">
                        Sign up
                    </button>
                </div>
            </div>
